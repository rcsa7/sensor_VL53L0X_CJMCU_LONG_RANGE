...
//-------------------------------
 ...
 if (realDistance<=0 && realDistance_S2<=0) {
    realDistance = whatDistance();
    realDistance_S2 = whatDistance_S2();
    }    
 ...
 if (realDistance_S2<=0 && realDistance<=0) {
     realDistance_S2 = whatDistance_S2();
     realDistance = whatDistance();    
    }    
 // Enquanto  leitura for maior mm
 ...
 if (realDistance_S2 < 200 && realDistance<=200)
    { 
        // Enquanto  leitura for menor mm
        while (realDistance_S2 < 150&&realDistance<200)
          {
            //Apaga o LED verde
            digitalWrite(ledverde, LOW);
         /// digitalWrite(ledverde, HIGH);
